...
Now, let's run FastQC on your sequencing file.
  ...
  ```bash
# Replace 'your_file.fastq' with the path to your sequencing file
file_path <- "your_file.fastq"
```

# Run FastQC
system(paste("fastqc", file_path))
...
Step 5: Determine if Trimming is Needed
